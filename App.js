...
import { FaBars, FaTimes, FaHome, FaCloudSun, FaInfoCircle, FaEnvelope, FaMapMarkedAlt } from 'react-icons/fa';
import './App.css';
            ...
            <div className={`app ${isNavOpen ? 'nav-open' : ''}`}>
              ...
              <div className={`side-navbar ${isNavOpen ? 'open' : ''}`}>
                <div className="nav-content">
                  <Link to="/" className="nav-item" title="Home">
                    <FaHome />
                    {isNavOpen && <span className="nav-text">Home</span>}
                  </Link>
                  <Link to="/weather" className="nav-item" title="Weather">
                    <FaCloudSun />
                    {isNavOpen && <span className="nav-text">Weather</span>}
                  </Link>
                  ...
                  <Link to="/contact" className="nav-item" title="Contact">
                    <FaEnvelope />
                    {isNavOpen && <span className="nav-text">Contact</span>}
                  </Link>
                </div>
              </div>
              ...
              <div className="main-content">
                <Switch>
                  ...
                  <Route path="/weather">
                    <div className="content">
                      <h3>Choose your State, District, and City to find your weather condition:</h3>
                      ...
                      <button className="get-weather-btn" onClick={() => getWeather(city)}>Get Weather</button>
